...
const CAUSES = ['vehicle_breakdown','accident','public_event','procession','vip_movement','construction','water_logging','pot_holes','congestion','protest','others']
...
const ScenarioForm = ({ label, form, setForm, color }: any) => {
  ...
  return (
    <div className="p-6 space-y-4 animate-slide-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <ScenarioForm label="A" form={formA} setForm={setFormA} color="var(--blue)" />
        <ScenarioForm label="B" form={formB} setForm={setFormB} color="var(--amber)" />
      </div>
