                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-5 p-4 rounded-lg border" style={{ background: 'rgba(59,130,246,0.06)', borderColor: 'rgba(59,130,246,0.2)' }}>
                      ...
                      <div className="text-xs leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                        The <strong style={{ color: 'var(--text-primary)' }}>crowd size</strong> is the dominant factor, contributing the most to the
                        {' '}<strong style={{ color: result.risk_color }}>{result.risk_level}</strong> risk prediction.
                        The <strong style={{ color: 'var(--text-primary)' }}>{form.time_of_day}</strong> time slot amplifies congestion by{' '}
                        {form.time_of_day === 'evening' ? '45%' : form.time_of_day === 'morning' ? '35%' : '15%'}.
